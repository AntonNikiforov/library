...
<div class="container jumbotron well-lg" style="margin-bottom: 100px">
    ...
    <div class="form-group">
        <button type="button" class="btn btn-default btn-group-justified" data-toggle="modal" data-target="#AddBookingModal">
            Add new booking
        </button>
    </div>

    <library:bookings list="${requestScope.list}" page="${requestScope.page}"/>
